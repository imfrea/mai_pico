...
* 本方案利用一整块亚克力分割而成，如厂家是按件计费要额外收取费用的，请考虑更换厂家。
  * 亚克力的质地较软且容易产生划痕，但成本低易于加工，你也可以采用其他板材（玻纤板等），板材的厚度也可以根据实际情况调整（注意改变板厚会同时要改变螺丝长度）

| 序号 | 名称                 | 规格                         | 所需数量 | 备注                                                        |
| ---- | -------------------- | ---------------------------- | -------- | ----------------------------------------------------------- |
| 1    | front.dwg 前面板     | 长409 宽282 厚4mm 白色亚克力 | 1/片     | 内含其他组件1+5共6件`\doc\assemble_case_1.jpg`              |
| 2    | mid.dwg 中框垫板     | 厚2mm 亚克力                 | 1/片     | 共8件                                                       |
...
| 14   | EVA海绵胶            | 4mm厚 宽度≤20mm              | 1/卷     | 用于前面板                                                  |
| 15   | sticker.png 装饰贴纸 | 282*119mm                    | 1/张     | 由“[剪刀Official](https://space.bilibili.com/89636132)”设计 |
