...
|      | 2.54mm 短排针       | 7.5mm 单排 5Pin 与12Pin            |                    | 3+3      | 5.5￥/5Pin 12Pin各10个 | 可选，与MPR121芯片**二选一** | MPR121模块附带的排针较长，焊接后剪短，或额外购买短排针       |
...
| 11   | 10r 电阻            | 0603                               | R4                 | 1        | 0.8￥/100颗            | 与SN74LV1T34**二选一**       |                                                              |
| 12   | SN74LV1T34DBVR 芯片 | SOT-23-5                           | U8                 | 1        | 0.49/颗                | 推荐（与10r电阻**二选一**）  |                                                              |
...
| 25   | 一些电子线             | 不是必须得用4Pin排线，不宜太粗，24或26AWG均可                |          |                      | 必要   | 用于按键板与io板之间的连接                                   |
...
| 28   | 成品便携屏（含驱动板） | 分辨率：1920*1080，尺寸：15.6 英寸，刷新率：120Hz（推荐）或 60Hz，内置扬声器。micro-HDMI或Type-C显示接口。 | 1        |                      | 必要   | 你也可以从头DIY一个15.6寸显示器，本文不详细讨论。如果你有180°开合的笔记本电脑，视情况可直接安装于上。 |
...
* 如果你第一次使用嘉立创，请不要错过领取和使用立创商城（购买元件）和3D打印服务的新人优惠券。使用**嘉立创下单小助手（客户端）**下单才能享受优惠。
...
* 由于非立创EDA格式Gerber文件不能享受免费打样，建议当月付费（20元）先下单5片按键PCB，次月即可领取2张通用格式免费打样优惠券，再分别0元下单io PCB和另外的5片按键PCB（返单），可最小化开销。或者一次性下单10片按键PCB（不包邮）并支付额外5元快递费。
  ...
  * 如遇**审核拆单嫌疑，请勿付款。**先取消订单，尝试次日换个时间段下单，或使用KiCad编辑PCB源文件添加任意丝印后导出Gerber。
