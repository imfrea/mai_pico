...
| 25   | 一些电子线             | 不是必须得用4Pin排线，不宜太粗，24或26AWG均可，建议选择“双头镀锡电子线 4cm” |          |                      | 必要   | 用于按键板与io板之间的连接                                   |
...
* 由于非立创EDA格式Gerber文件不能享受免费打样，建议①当月付费（20元）先下单5片按键PCB，次月即可领取2张通用格式免费打样优惠券，再分别0元下单io PCB和另外的5片按键PCB（返单），可最小化开销（共3次打样，等待时间长）。或者②一次性下单10片按键PCB（不包邮，需支付额外5元快递费。共2次打样，等待时间短）。
